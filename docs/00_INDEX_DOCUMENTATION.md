...
| `92_CADRAGE_SCENARIO_SC-04.md`                    | Cadrage SC-04 — optimisation globale d'un planning existant : son élément propre est la **profondeur temporelle**, l'historique se **recalcule** au lieu de se recevoir, six arbitrages tranchés, six lots O0→O5 livrés — **O0 à O4 le 2026-08-17**, la liste explicite de créneaux ajustables (**O5**) le 2026-08-18 |
| `92_CADRAGE_SCENARIO_SC-05.md`                    | Cadrage SC-05 — arbitrage de répartition entre deux salariés : ce que le chantier équité débloque, la brique manquante (affectation bornée au couple), **six arbitrages à rendre par le métier**, contrats proposés, découpage A0→A4 |
