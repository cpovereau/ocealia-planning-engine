...
| `92_CADRAGE_SCENARIO_SC-04.md`                    | Cadrage SC-04 — optimisation globale d'un planning existant : son élément propre est la **profondeur temporelle**, l'historique se recalcule au lieu de se recevoir, **quatre arbitrages tranchés et deux ouverts** (degré de liberté, pondération), découpage O0→O4 |
